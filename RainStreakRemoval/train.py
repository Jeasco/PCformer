...
parser.add_argument('--train-dataset', type=str, default='./datasets/Rain13k/train', help='dataset folder for train (change for different datasts)')
parser.add_argument('--val-dataset', type=str, default='./datasets/Rain13k/test', help='dataset forder for val')
